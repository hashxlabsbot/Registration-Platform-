...
export default function AdminLoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Glow orbs */}
      <div
        className="absolute top-1/3 left-1/3 w-[500px] h-[500px] rounded-full blur-[160px] opacity-25 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #2e7d32, transparent 70%)' }}
      />
      <div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full blur-[120px] opacity-20 pointer-events-none"
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        >
            ...
            <div className="mx-auto mb-5 relative w-fit">
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 32px rgba(46,125,50,0.5), 0 0 0 1px rgba(74,222,128,0.15)',
                }}
              >
          ...
          <form onSubmit={handleSubmit} className="px-10 py-8 space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    e.target.style.border = '1px solid rgba(200,169,110,0.45)';
            ...
            {error && (
              <div
                className="flex items-center gap-2 rounded-xl px-4 py-3 text-xs text-red-300"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-xl font-black text-sm tracking-wider transition-all"
              style={
                loading
